            ...
            >
                <div className="flex flex-col gap-4 items-center">
                    <div className="flex items-center gap-2 w-full">
                        ...
                        <h3 className="m-plus-rounded-1c-regular lg:text-2xl text-xl">Hey! Wait a minute !</h3>
                    </div>
                    ...
                    <div className="w-full bg-white p-6 rounded-lg text-center [box-shadow:0_0_5px_0_rgba(0,0,0,0.3)] flex flex-col gap-4">
                        <h2 className="m-plus-rounded-1c-regular lg:text-3xl text-xl">
                            ...
                            Start your <span className="m-plus-rounded-1c-medium capitalize">{waitAMinuteValue?.type}</span> Session now ?
                        </h2>
                    ...
                    <div className="flex w-full gap-2 mt-2">
                        <button
                            ...
                            onClick={() => { dispatch(WaitAMinuteValue({ open: false, type: "" })); router.push("/pricing") }}
                        >
