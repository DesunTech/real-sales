...
const AboutUs = () => {
  return (
    <div className="bg-[#212326]">
      ...
      <div className="z-10 page-container mx-auto container px-4 flex justify-between items-center lg:gap-4 gap-8 lg:flex-row flex-col-reverse py-12">
        <div data-aos="fade-right" className="lg:w-1/2 w-full">
          <div className="flex flex-col lg:items-start items-center gap-5">
            ...
            <p className="text-[15px] text-white sora-regular w-[90%]">
              Unlike generic AI models, our platform is powered by AI personas
              modeled after
              <span className="sora-semibold"> real industry decision-makers</span>
              <br />
      ...
      <div className="z-10 page-container mx-auto container px-4 flex justify-between items-center lg:gap-4 gap-8 lg:flex-row-reverse flex-col-reverse py-12">
        <div data-aos="fade-left" className="lg:w-1/2 w-full">
          <div className="flex flex-col lg:items-end items-center gap-5">
            ...
            <h1 className="lg:text-[65px] lg:text-right text-left text-3xl text-white m-plus-rounded-1c-regular">
              Transform your Sales Team into
              <br />
              Top Performer
            </h1>
            <p className="text-[15px] text-white lg:text-end items-start sora-regular w-[90%]">
              Our AI-powered interactive platform helps sales teams to
              <span className="sora-semibold">go beyond the pitch</span>
              &nbsp;and master the art of connection, cross-selling, and deal-closing.&nbsp;
      ...
      {/* Divider with second background image */}
      ...
      <div className="z-10 page-container mx-auto container px-4 flex justify-between items-center lg:gap-4 gap-8 lg:flex-row flex-col-reverse py-12">
        <div data-aos="fade-right" className="lg:w-1/2 w-full">
          <div className="flex lg:items-start items-center flex-col gap-5">
            ...
            <p className="text-[32px] text-white m-plus-rounded-1c-regular lg:text-left text-center">
            ...
            <div className="flex flex-col gap-5">
              {[{
                ...
                desc: "Inability of Navigating complex portfolio and propose appropriate product."
              }].map((item, idx) => (
                <div key={idx} className="flex flex-col gap-2 py-3 px-4 border-l border-solid border-[#14558CB2] bg-[linear-gradient(90deg,rgba(20,85,140,0.3)_0%,rgba(20,85,140,0)_63.5%)]">
