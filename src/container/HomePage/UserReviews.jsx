            ...
            <Tabs
              ...
              slots={{
                StartScrollButtonIcon: () => (
                  <div className="bg-white w-12 h-10 z-10 flex items-center justify-center absolute left-[10px]">
                    <ArrowRight
                      stroke="#060606"
                      width={19}
                      height={13}
                ...
                EndScrollButtonIcon: () => (
                  <div className="bg-white w-12 h-10 z-10 flex items-center justify-center absolute right-[10px]">
                    <ArrowRight stroke="#060606" width={19} height={13} />
                  </div>
                ),
              }}
            >
              {eviewsArr.map((val, idx) => (
                <Tab
                  key={idx}
                  className="!py-0 !px-1 lg:h-[32.5rem] h-[22.5rem]"
                  ...
                  label={
                    <div
                      className={`rounded-full overflow-hidden flex-shrink-0 transition-all duration-300 w-[120px] 
                        ${
                          idx === value
                            ? `lg:h-[32.5rem] h-[22.5rem] border-4 border-solid border-[#FFDE5A] !shadow-[0px_5px_20px_0px_#00000040]`
                            : `lg:h-[30rem] h-[20rem]`
                        }`}
                    >
                      <Image
